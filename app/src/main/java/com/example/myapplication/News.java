        ...
        switch(HomeFragment.roundNo){
            case 1:
                ...
                if(PowerCardFragment.pc2flag==1){
                    setNews.add("Union of IT workers plans to declare strike due to long working hours and increasing deadline pressure.");
            ...
            case 2:
                ...
                if(PowerCardFragment.pc2flag==1){
                    setNews.add("Friction between board member of Utopia Bank regarding their upcoming policy <name> to reduce the repo rate by 2%.");
                    PowerCardFragment.pc2flag=0;
                }
                break;
            case 3:
                ...
                if(PowerCardFragment.pc2flag==1){
                    setNews.add("UTOPIA Investments planning to increase their mutual funds share in Air Utopia to 29.33% from 21%.");
                    PowerCardFragment.pc2flag=0;
                }
                break;
            case 4:
